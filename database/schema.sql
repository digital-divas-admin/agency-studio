...
CREATE TABLE agency_models (
    ...
    -- Expected shape: { "path": "model.safetensors", "triggerWord": "sks_name", "weight": 0.7, "endpointId": "..." }
...
CREATE TABLE gallery_items (
    ...
    source TEXT DEFAULT 'generated' CHECK (source IN ('upload', 'generated')),
...
CREATE INDEX idx_agency_models_agency ON agency_models(agency_id);
CREATE INDEX idx_agency_models_slug ON agency_models(agency_id, slug);

CREATE INDEX idx_gallery_items_agency_user ON gallery_items(agency_id, user_id);
CREATE INDEX idx_gallery_items_agency_model ON gallery_items(agency_id, model_id);
